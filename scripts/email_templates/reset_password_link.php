<!--<p>Dear {first_name}, </p>-->
<!---->
<!--<p>You Have Successfully Initiated Password Change Request.</p>-->
<!---->
...
<head>
    ...
    <title>Password Reset - Online Birthday Manager</title>
    ...
    <tr>
        <td>
            <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">
                Password Reset - Online Birthday Manager
            </div>
        </td>
    </tr>
</table>
...
<!--                                        <tr>-->
<!--                                            <td align="center">-->
<!--                                                <a href="https://templates.emailoctopus.com" style="display: block; border-style: none !important; border: 0 !important;"><img width="200" border="0" style="display: block; width: 200px;" src="http://i.imgur.com/zsjieJb.png" alt="" /></a>-->
<!--                                            </td>-->
<!--                                        </tr>-->
<!--                                    </table>-->
<!--                                </td>-->
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <div style="line-height: 21px">
                                        ...
                                        <p style="color: #838383; font-family: 'Source Sans Pro', Helvetica, Calibri, sans-serif; line-height: 21px;font-size:15px;" class="align-center outlook-font">You recently requested to reset your password for your Online Birthday Manager account. Use the button below to reset it. </p>
                                    </div>
                                </td>
                            <tr>
                                <td align="center">
                                    <table border="0" align="center" width="200" cellpadding="0" cellspacing="0" style="border: 1px solid #5c9085; border-radius: 50px;">
                                        ...
                                        <tr>
                                            <td align="center" style="color: #5c9085; font-size: 13px; font-family: 'Titillium Web', Helvetica Neue, Calibri, sans-serif; font-weight: 700; line-height: 13px;">
                                                <div class="text_container outlook-font" style="line-height: 24px;">
                                                    <a href="{reset_password_link}" style="ine-height: 24px;color: #5c9085; text-decoration: none;">RESET PASSWORD</a>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    <div style="line-height: 21px">
                                        ...
                                        <p style="color: #838383; font-family: 'Source Sans Pro', Helvetica, Calibri, sans-serif; line-height: 21px;font-size:15px;" class="align-center outlook-font">If you did not request a password reset, please ignore this email or
                                            contact us at hello@onlinebirthdaymanager.com if you have questions</p>

                                        <p style="color: #838383; font-family: 'Source Sans Pro', Helvetica, Calibri, sans-serif; line-height: 21px;font-size:15px;" class="align-center outlook-font">Thanks,</p>

                                        <p style="color: #838383; font-family: 'Source Sans Pro', Helvetica, Calibri, sans-serif; line-height: 21px;font-size:15px;" class="align-center outlook-font">The Online Birthday Manager Team</p>
