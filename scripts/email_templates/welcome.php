<!--<p>Dear {first_name}, </p>-->
<!--<p>Welcome to Online Birthday Manager.</p>-->
<!---->
																...
																<div class="contentEditableContainer contentTextEditable">
																	<div class="contentEditable" align='center'>
																		<p >
																			...
																			<br>
																			We are trying to make office birthday celebrations more joyful and convenient. We are always looking for ways to make your experience even better.
																			<br>
																			<br>
																			Please use this website in your office to manage your office birthday celebrations and if there is anything we should be doing to improve Birthday Manager, please let us know.
																			<br>
																			<br>
																			Have questions? Get in touch with us via Facebook or email. Just send an email to us at hello@onlinebirthdaymanager.com
																			<br>
																			<br>
																			Thanks again for joining birthday manager -- We hope you love it!
																			<br>
																...
																<table>
																	<tr>
																		<td align='center' bgcolor='#1A54BA' style='background:#DC2828; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
																			<div class="contentEditableContainer contentTextEditable">
																				<div class="contentEditable" align='center'>
																					<a target='_blank' href='{magic_link}' class='link2' style='color:#ffffff;'>Go to Dashboard</a>
																				</div>
																			</div>
																		</td>
																	</tr>
																		...
																		<td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
																				<div class="contentEditable" align='center'>
																					<p  style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
																						<span style='font-weight:bold;'>Online Birthday Manager</span>
																						<br>
																						London
																						<br>
																						<a target='_blank' href="[FORWARD]">Facebook</a><br>
