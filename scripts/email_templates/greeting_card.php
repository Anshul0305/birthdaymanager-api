...
<head>
    ...
    <title>Greeting Card - Online Birthday Manager</title>
    ...
    <tr>
        <td>
            <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">
                Greeting Card - Online Birthday Manager
            </div>
        </td>
    </tr>
</table>
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <div style="line-height: 21px">
                                        ...
                                        <p style="color: #838383; font-family: 'Source Sans Pro', Helvetica, Calibri, sans-serif; line-height: 21px;font-size:15px;" class="align-center outlook-font">{sender_name} has sent you a greeting card. </p>
                                    </div>
                                </td>
                            <tr>
                                <td align="center">
                                    <table border="0" align="center" width="200" cellpadding="0" cellspacing="0" style="border: 1px solid #5c9085; border-radius: 50px;">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;</td></br>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    <div style="line-height: 21px">
                                        ...
                                        <p style="color: #838383; font-family: 'Source Sans Pro', Helvetica, Calibri, sans-serif; line-height: 21px;font-size:15px;" class="align-center outlook-font">For more details, contact us at hello@onlinebirthdaymanager.com</p>
                                        ...
                                        <p style="color: #838383; font-family: 'Source Sans Pro', Helvetica, Calibri, sans-serif; line-height: 21px;font-size:15px;" class="align-center outlook-font">Online Birthday Manager Team</p>
